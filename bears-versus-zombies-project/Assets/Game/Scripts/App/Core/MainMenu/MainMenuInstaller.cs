...
namespace SampleGame.App
{
    public sealed class MainMenuInstaller : MonoInstaller
    {
        ...
        [SerializeField, Required] private RegionsIconsProvider _regionsIconsProvider;
        ...
        public override void InstallBindings()
        {
            ...
            Container.BindInterfacesAndSelfTo<RegionsIconsProvider>()
                .FromInstance(_regionsIconsProvider)
                .AsSingle();
            
            Container.QueueForInject(_regionsIconsProvider);
        ...
        private ILoadingOperation CreateLoadingOperation()
        {
            return new SequenceOperation(weight: 1,
                ...
                new ParallelOperation(weight: 1,
                    new InlineLoadingOperation(_assetProvider.InitializeAsync),
                    new InlineLoadingOperation(_regionsIconsProvider.InitializeAsync)
                ),
